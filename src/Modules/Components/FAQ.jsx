					...
					{({ open }) => (
						<>
							...
							>
								<span>Banhart</span>
								<ChevronUpIcon
									className={`${open ? 'rotate-180 transform' : ''} h-5 w-5 text-gold-400`}
								/>
							</Disclosure.Button>
				...
				>
					{({ open }) => (
						<>
							...
							<Disclosure.Panel className="px-4 pt-4 pb-2 text-lg text-black">No.</Disclosure.Panel>
						</>
					)}
				</Disclosure>
				<Disclosure
				...
				>
					{({ open }) => (
						<>
							...
							<Disclosure.Panel className="px-4 pt-4 pb-2 text-lg text-white">No.</Disclosure.Panel>
						</>
					)}
				</Disclosure>
				<Disclosure
